...
Post.create!(title: 'What to expect on your first day',
             content: Faker::Lorem.paragraphs(sentence_count: 15, supplemental: true,
                                              random_sentences_to_add: 7))
Post.create!(title: 'The Golden Rule of sparring',
             content: Faker::Lorem.paragraphs(sentence_count: 20, supplemental: true,
                                              random_sentences_to_add: 7))
Post.create!(title: 'How to be respectful',
             content: Faker::Lorem.paragraphs(sentence_count: 22, supplemental: true,
                                              random_sentences_to_add: 6))

@posts = Post.all

Product.create!(name: 'Head Gear', type: 'Gear', brand: 'Everlast', image_url: 'everlast_head_gear.jpeg',
                review: Faker::Lorem.paragraphs(sentence_count: 2, supplemental: true, random_sentences_to_add: 2))
Product.create!(name: 'Heavy Bag', type: 'Equipment', brand: 'Everlast', image_url: 'everlast_heavy_bag.jpeg',
                review: Faker::Lorem.paragraphs(sentence_count: 3, supplemental: true, random_sentences_to_add: 2))
Product.create!(name: 'Thai Pads', type: 'Gear', brand: 'Everlast', image_url: 'everlast_pads.jpeg',
                review: Faker::Lorem.paragraphs(sentence_count: 4, supplemental: true, random_sentences_to_add: 2))
...
Product.create!(name: 'Wall Mount Training Bag', type: 'Equipment', brand: 'Everlast',
                image_url: 'everlast_wall_mount.jpeg', review: Faker::Lorem.paragraphs(2, supplemental: true, random_sentences_to_add: 2))
...
Product.create!(name: 'Rash Guard', type: 'Apparel', brand: 'Everlast', image_url: 'everlast_rashguard.jpeg',
                review: Faker::Lorem.paragraphs(sentence_count: 5, supplemental: true, random_sentences_to_add: 2))
